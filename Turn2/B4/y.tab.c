...
#line 8 "variable_check.y" /* yacc.c:339  */
...
{
  "$end", "error", "$undefined", "DATATYPE", "EQUAL", "SEMIC", "ID",
  "NUM", "$accept", "S", "S1", "S2", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 21 "variable_check.y" /* yacc.c:1646  */
    {
	printf("\n Correct syntax");
	flag=1;
}
#line 1208 "y.tab.c" /* yacc.c:1646  */
  ...
  case 5:
#line 28 "variable_check.y" /* yacc.c:1646  */
    {
	printf("\n Correct syntax");
	flag=1;
}
...
#line 34 "variable_check.y" /* yacc.c:1906  */
