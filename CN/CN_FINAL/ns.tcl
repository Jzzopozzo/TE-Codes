...
output=====
res@res-HP-280-G2-MT-Legacy:~/Desktop/FINAL 1$ ns ns.tcl
res@res-HP-280-G2-MT-Legacy:~/Desktop/FINAL 1$ Cannot connect to existing nam instance. Starting a new one...
