...
root@lalit-HP-Pro-3330-MT:/home/lalit# ./a.out 8090
New client connected to port: 45371 and IP 127.0.0.1 
From CLIENT:n1=2
From CLIENT:n2=3
...
res@res-HP-280-G2-MT-Legacy:~/Desktop/FINAL /assignment 7/Calculator$ ./a.out 8090
