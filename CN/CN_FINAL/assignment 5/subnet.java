/* TE-B 
ROLL NO: 
Write a program to demonstrate subnetting and find the subnet mask.
*/
...
/*
Output
res@res-HP-280-G2-MT-Legacy:~/Desktop/FINAL $ javac subnet.java
res@res-HP-280-G2-MT-Legacy:~/Desktop/FINAL $ java subnet
