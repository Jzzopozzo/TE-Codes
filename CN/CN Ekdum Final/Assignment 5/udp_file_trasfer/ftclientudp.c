/*TE-B 
ROLL NO: 
Write a program using UDP sockets to enable file transfer between two machines. 
Demonstrate the packets captured traces using wireshark Packet analyzer Tool peer to peer mode*/
...
int main(int argc, char **argv)
{
	...
	char send_data[BUFFER]= "add.txt"; // send buffer: hold information to send to server
